# This Makefile is for the Religion::Bible::Regex::Reference extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Religion/Bible/Regex/Reference.pm]
#     AUTHOR => q[Daniel Holmlund <holmlund.dev@gmail.com>]
#     NAME => q[Religion::Bible::Regex::Reference]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Test::Base=>q[0], Religion::Bible::Regex::Config=>q[0], version=>q[0], Religion::Bible::Regex::Regex=>q[0] }
...
MAKE = make
FULLEXT = Religion/Bible/Regex/Reference
BASEEXT = Reference
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Religion/Bible/Regex/Reference.pm
...
TO_INST_PM = lib/Religion/Bible/Regex/Reference.pm

PM_TO_BLIB = lib/Religion/Bible/Regex/Reference.pm \
...
manifypods : pure_all  \
	lib/Religion/Bible/Regex/Reference.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Religion/Bible/Regex/Reference.pm $(INST_MAN3DIR)/Religion::Bible::Regex::Reference.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  ...
	  $(BASEEXT).exp 
	- $(RM_RF) \
	  Religion-Bible-Regex-Reference-* blib 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    Religion::Bible::Regex::Regex: 0' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Religion-Bible-Regex-Regex" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Religion/Bible/Regex/Reference.pm blib/lib/Religion/Bible/Regex/Reference.pm 
